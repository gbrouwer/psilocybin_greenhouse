...
if __name__ == '__main__':
    ...
    while True:
        ...
        try:
            ...
            image1 = cv2.resize(image1, (214,160), interpolation=cv2.INTER_NEAREST)
            image2 = cv2.resize(image2, (214,160), interpolation=cv2.INTER_NEAREST)
            dashboard_image[20:180,:214,:] = image1
            dashboard_image[20:180,244:214+244,:] = image2
